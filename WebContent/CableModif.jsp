...
<br><br><br><br>
<center>
<h2> Modifier Un Cable </h2> 
<br><br>
<form action ="cabmod" method="post">
<table border="3" width="20%">
	...
	<tr>
		...
		<tr> <td> <input type="submit" name="action3" value=" modifier " class="btn_taille_egale" ><td></tr>
</table>
</form>
</center>
