...
<% if (request.getAttribute("test")!=null ) { %> <h4 style="color: red">il existe déjà un compte avec le login que vous avez entrer  !</h4> <%} %></p>
</form>
</article>
</br> 
<article class="right">
...
<% if (request.getAttribute("test1")!=null ) { %> <h4 style="color: red">Login ou Mot de passe incorrecte ,Réssayez !</h4> <%} %></p>
